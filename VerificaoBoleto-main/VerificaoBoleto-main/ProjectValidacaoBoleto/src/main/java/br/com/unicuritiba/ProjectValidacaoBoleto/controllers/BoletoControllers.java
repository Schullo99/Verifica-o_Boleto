...
public class BoletoControllers {
    ...
    public ResponseEntity<?> verificarBoleto(@RequestBody BoletoRequestDTO request) {
        ...
        // 3. Validar CPF
        if (request.getCpfCliente() == null || !request.getCpfCliente().matches("\\d{11}")) {
        ...
        novoBoleto.setCpf(request.getCpfCliente());
